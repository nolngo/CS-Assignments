...
def get_bot_response(user_response):     #this is the bot's function, basically the brain of the bot where all the thinking and randomization happens
...
while True:     #boolean while loop, program will restart and run again unless the user inputs exit
  ...
  bot_response = get_bot_response(user_response)     #this defines the bot's answer as the return in the function
